...
fun InstrumentDetailView(
    ...
    Column(
        ...
        Column(
            ...
            if (selected.inventoryNumber != null) DetailRow("Inventory", selected.inventoryNumber!!)
                    ...
                    items(calibrations) { cal ->
                        Column(
                            ...
                            Row(horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                                Text(cal.type.name.replace("_", " "), style = MaterialTheme.typography.bodySmall)
                                Text(
                                    cal.result.name,
                            ...
                            if (cal.comment.isNotBlank()) Text(cal.comment, style = MaterialTheme.typography.bodySmall)
                        }
...
private fun DetailRow(label: String, value: String) {
    Row(
        ...
        Text(label, style = MaterialTheme.typography.labelSmall, modifier = Modifier.width(80.dp))
